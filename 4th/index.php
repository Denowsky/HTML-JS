...
$experience = [
    [
        'name' => 'Дегустатор чикенбургеров',
        'period' => 'Mar 2022 - <span class="w3-tag w3-teal w3-round">Current</span>',
        'occupation' => 'Ем чикенбургеры'
    ],
    [
        'name' => 'Дегустатор наггетсов',
        'period' => 'Mar 2022 - <span class="w3-tag w3-teal w3-round">Current</span>',
        'occupation' => 'Ем наггетсы'
    ],
    [
        'name' => 'Дегустатор кока-колы',
        'period' => 'Mar 2022 - <span class="w3-tag w3-teal w3-round">Current</span>',
        'occupation' => 'Пью кока-колу'
    ],
    [
        'name' => 'Hitman',
        'period' => 'Mar 2018 - Mar 2021',
        'occupation' => 'Был тяжёлый период, я зарабатывал как мог'
    ]
        ]
?>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $exp['period']?></span></h6>
          <p><?php echo $exp['occupation']?>.</p>
          <hr>
        </div>
        <?php endforeach; ?>
      </div>
